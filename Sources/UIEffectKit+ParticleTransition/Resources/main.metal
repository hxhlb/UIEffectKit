...
vertex ParticleTransitionSystem::TrollVertex
PTS_ParticleVertex(const device ParticleTransitionSystem::TrollVertex *vertices [[buffer(0)]],
                   const device float2 &resolution [[buffer(1)]],
                   const device ParticleTransitionSystem::TrollParticle *particles [[buffer(2)]],
                   const device float2 &targetFrameSize [[buffer(3)]], const device float &stepSize [[buffer(4)]],
                   unsigned int vid [[vertex_id]], unsigned int particleId [[instance_id]]) {
...
kernel void PTS_UpdateParticles(device ParticleTransitionSystem::TrollParticle *particles [[buffer(0)]],
                                constant uint &particleCount [[buffer(1)]], uint index [[thread_position_in_grid]]) {
