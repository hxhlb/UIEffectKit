...
import Foundation
    ...
    public extension UIView {
        func makeSnapshotCGImage() -> CGImage? {
            createViewSnapshot().cgImage
        }
    }

    // makeSnapshotCGImage is available on UIView below
    ...
    public extension NSView {
        func makeSnapshotCGImage() -> CGImage? { createViewSnapshot() }
    }
#endif
